...
?>
    ...
    <body>
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">Nombre del Área</span>
                                                        </div>
                                                        <input type="text" id="pro_nombre" name="pro_nombre" class="form-control form-control-sm" placeholder="RRHHH" minlength="4" required>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="pro_centro" name="pro_centro" class="form-control form-control-sm" placeholder="Subgerencia de ventas" minlength="4" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
        ...
        <script src="<?= BASE ?>assets/js/adm_area_x.js?v=<?= time(); ?>" type="text/javascript"></script>
    </body>
