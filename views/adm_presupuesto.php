...
?>
    ...
    <head>
        ...
        <title>Registro Presupuestos</title>
    ...
    <body>
                                            ...
                                            <div class="row collapse-body">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        class="form-control form-control-sm" placeholder="Adquisición de equipos..." minlength="4" required>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" id="pro_fecha" name="pro_fecha" 
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="pro_monto" name="pro_monto"
                                                        class="form-control form-control-sm" placeholder="000.00" 
                                                        onKeyPress="return valDecimal_x(event,this)"
                                                        required>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="file" id="pro_documento" name="pro_documento" 
                                                        class="form-control form-control-sm" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="pro_tipo" name="pro_tipo" 
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="pro_estado" name="pro_estado" 
                                                            class="form-control form-control-sm" 
                                                            required>
                                                            <option value="0" disabled>-- Seleccione --</option>
                                                        </select>
        ...
        <script src="<?= BASE ?>assets/js/adm_presupuesto_x.js?v=<?= time(); ?>" type="text/javascript"></script>
    </body>
